...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-progress">
            ...
            <p class="sp-value"><?php echo e($progress['completed'] ?? 0); ?> / <?php echo e($progress['total'] ?? 0); ?> Courses</p>
        ...
        <div class="profile-grid">
            ...
            <div class="profile-col">
                ...
                <div class="card-block">
                    <div class="profile-info">
                        <div class="avatar-circle" <?php if($user->avatar_url ?? null): ?> style="background-image:url('<?php echo e($user->avatar_url); ?>')" <?php endif; ?>>
                            <?php if (! ($user->avatar_url ?? null)): ?>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 3.5-7 8-7s8 3 8 7"/></svg>
                            <?php endif; ?>
                        </div>
                        <div class="profile-meta">
                            <h3><?php echo e($user->name ?? 'Student'); ?></h3>
                            <div class="meta-row">
                                ...
                                <?php endif; ?>
                                <?php if($user->joined_at ?? null): ?>
                                    <span>
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>
                                        Joined on <?php echo e($user->joined_at->format('M d, Y')); ?>
                ...
                <div class="card-block">
                    ...
                    <?php if($user->about ?? null): ?>
                        <p class="about-text"><?php echo e($user->about); ?></p>
                    <?php endif; ?>
                    <?php if($user->date_of_birth ?? null): ?>
                        <div class="detail-row">
                            <span class="label">Date of Birth:</span>
                            <span class="value"><?php echo e($user->date_of_birth); ?></span>
                        </div>
                    <?php endif; ?>
                    <?php if($user->gender ?? null): ?>
                        <div class="detail-row">
                            <span class="label">Gender:</span>
                            <span class="value"><?php echo e($user->gender); ?></span>
                        </div>
                    <?php endif; ?>
                    <?php if($user->education ?? null): ?>
                        <div class="detail-row">
                            <span class="label">Education:</span>
                            <span class="value"><?php echo e($user->education); ?></span>
                        </div>
                    <?php endif; ?>
                    <?php if($user->bio ?? null): ?>
                        <div class="detail-row">
                            <span class="label">Bio:</span>
                            <span class="value"><?php echo e($user->bio); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="card-block">
                    ...
                    <div class="settings-row">
                        ...
                        <span class="value-text"><?php echo e($user->email ?? ''); ?></span>
                    ...
                    <div class="settings-row">
                        ...
                        <select class="settings-select" name="language">
                            <option <?php if(($user->language ?? 'English') === 'English'): echo 'selected'; endif; ?>>English</option>
                            <option <?php if(($user->language ?? '') === 'Filipino'): echo 'selected'; endif; ?>>Filipino</option>
                        </select>
                    </div>
                    <div class="settings-row">
                        <span class="label">
                        ...
                        <select class="settings-select" name="timezone">
                            ...
                            ?>
                            <?php $__currentLoopData = $tzLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php if($currentTz === $val): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
            ...
            <div class="profile-side">
                ...
                <div class="quick-grid">
                    <a href="<?php echo e(route('courses.browse')); ?>" class="quick-card">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
                        Courses Enrolled
                    </a>
                    <a href="<?php echo e(route('badges.index')); ?>" class="quick-card">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l3 6 7 1-5 5 1.5 7L12 17l-6.5 4L7 14 2 9l7-1 3-6z"/></svg>
                        Badges Earned
                    </a>
                    <a href="<?php echo e(route('certificates.index')); ?>" class="quick-card">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="5"/><path d="M8 13l-2 8 6-3 6 3-2-8"/></svg>
                        Certificates
                    </a>
                    <a href="<?php echo e(route('analytics.index')); ?>" class="quick-card">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg>
                        Hours Learned
                    </a>
                </div>
                ...
                <div class="panel-card">
                    <div class="panel-card-head">
                        ...
                        <a href="<?php echo e(route('badges.index')); ?>">View All</a>
                    </div>
                ...
                <div class="panel-card">
                    <div class="panel-card-head">
                        ...
                        <a href="<?php echo e(route('analytics.index')); ?>">View All</a>
                    </div>
                    <div class="panel-card-body">
                        <?php $__empty_1 = true; $__currentLoopData = $activities ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <p><?php echo e($activity); ?></p>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="panel-card">
                    ...
                    <div class="panel-card-body student-id-body">
                        <div>
                            <div class="student-id-number"><?php echo e($studentId); ?></div>
                            <div class="student-id-label">Your unique student identification number</div>
                        </div>
                        <button type="button" class="student-id-copy" onclick="copyStudentId(this, '<?php echo e($studentId); ?>')">Copy</button>
                    </div>
                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" id="edit_dob" name="date_of_birth"
                                value="<?php echo e(old('date_of_birth', isset($user->date_of_birth) ? \Carbon\Carbon::parse($user->date_of_birth)->format('Y-m-d') : '')); ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <select id="edit_gender" name="gender">
                                ...
                                <option value="Prefer not to say" <?php if(($user->gender ?? '') === 'Prefer not to say'): echo 'selected'; endif; ?>>Prefer not to say</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="edit_language" name="language">
                                <option value="English"  <?php if(($user->language ?? 'English') === 'English'): echo 'selected'; endif; ?>>English</option>
                                <option value="Filipino" <?php if(($user->language ?? '') === 'Filipino'): echo 'selected'; endif; ?>>Filipino</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="edit_timezone">Time Zone</label>
                            <select id="edit_timezone" name="timezone">
                                <option value="Asia/Manila"      <?php if(($user->timezone ?? 'Asia/Manila') === 'Asia/Manila'): echo 'selected'; endif; ?>>(GMT+8:00) Asia/Manila</option>
                                <option value="UTC"              <?php if(($user->timezone ?? '') === 'UTC'): echo 'selected'; endif; ?>>UTC</option>
                                <option value="America/New_York" <?php if(($user->timezone ?? '') === 'America/New_York'): echo 'selected'; endif; ?>>(GMT-5:00) New York</option>
                                <option value="Europe/London"    <?php if(($user->timezone ?? '') === 'Europe/London'): echo 'selected'; endif; ?>>(GMT+0:00) London</option>
                            </select>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\Admin\Herd\Micro-credentials\resources\views/Student_Profile.blade.php ENDPATH**/ ?>